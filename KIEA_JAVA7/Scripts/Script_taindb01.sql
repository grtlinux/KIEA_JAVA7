...
SELECT TIME(F_DTTM), DOUBLE(F_AUSE)/1024/1024/1024, DOUBLE(F_USE)/1024/1024/1024, F_TTL, F_FRE, F_USE, F_AFRE, F_AUSE, CEIL(F_FREP * 100) / 100, CEIL(F_USEP * 100) / 100 FROM TB_MEMREC;
