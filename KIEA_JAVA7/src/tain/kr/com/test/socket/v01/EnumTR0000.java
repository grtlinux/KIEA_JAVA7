...
public enum EnumTR0000 {
	 ...
	 *
	 * <PRE>
	 *   -. ClassName  : EnumTR0000
	 *   -. MethodName : EnumTR0000
	 *   -. Comment    :
	 *   -. Author     : taincokr
	 *   -. First Date : 2016. 2. 2. {time}
	 * </PRE>
	 ...
	 * @param defVal
	 */
	EnumTR0000(char type, char lead, int off, int len, String name, String desc, String defVal) {
		this.type = type;
		this.lead = lead;
		this.off = off;
		this.len = len;
	...
	private static final Logger log = Logger.getLogger(EnumTR0000.class);
	...
	private static void setLenTotal() throws Exception {
		...
		if (flag) {
			...
			for (EnumTR0000 fld : EnumTR0000.values()) {
				off += fld.getLen();
			}
