 ...
 *
 */
public class Shell0 extends ShellBase {

	private static boolean flag = true;

	private static final Logger log = Logger.getLogger(Shell0.class);
	...
	public void processCommand(ShellCommandHandler handler, String[] args) throws ShellCommandUsageException, ShellCommandExecException {
		try {
			...
			if (handler instanceof SigarCommandBase0) {
				((SigarCommandBase0) handler).flush();
			}
		} finally {
