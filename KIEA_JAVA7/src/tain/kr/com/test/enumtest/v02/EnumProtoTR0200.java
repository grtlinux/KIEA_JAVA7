...
public enum EnumProtoTR0200 {
	 ...
	 *
	 * <PRE>
	 *   -. ClassName  : EnumProtoTR0200
	 *   -. MethodName : EnumProtoTR0200
	 *   -. Comment    :
	 *   -. Author     : taincokr
	 *   -. First Date : 2016. 2. 1. {time}
	 * </PRE>
	 ...
	 * @param defVal
	 */
	EnumProtoTR0200(char type, char lead, int off, int len, String name, String desc, String defVal) {
		this.type = type;
		this.lead = lead;
		this.off = off;
		this.len = len;
	...
	private static final Logger log = Logger.getLogger(EnumProtoTR0200.class);
	...
	private static void setLenTotal() throws Exception {
		...
		if (flag) {
			...
			for (EnumProtoTR0200 fld : EnumProtoTR0200.values()) {
				off += fld.getLen();
			}
