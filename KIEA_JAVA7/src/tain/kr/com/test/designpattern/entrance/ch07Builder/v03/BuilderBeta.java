 ...
 *
 */
public final class BuilderBeta extends AbstBuilder {

	private static boolean flag = true;

	private static final Logger log = Logger.getLogger(BuilderBeta.class);
