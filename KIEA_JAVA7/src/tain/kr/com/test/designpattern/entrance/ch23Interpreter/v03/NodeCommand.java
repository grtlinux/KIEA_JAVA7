 ...
 *
 */
public class NodeCommand extends AbstNode {

	private static boolean flag = true;

	private static final Logger log = Logger.getLogger(NodeCommand.class);

	///////////////////////////////////////////////////////////////////////////////////////////////
	
	private AbstNode node;
	...
	public void parse(Dep1Context context) throws Exp1ParseException {
		...
		if (context.currentToken().equalsIgnoreCase("REPEAT")) {
			node = new NodeRepeatCommand();
		} else {
			node = new NodePrimitiveCommand();
		}
		node.parse(context);
	}
