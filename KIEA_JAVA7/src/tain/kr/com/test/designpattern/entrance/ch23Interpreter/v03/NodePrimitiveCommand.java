 ...
 *
 * <PRE>
 *   -. FileName   : NodePrimitiveCommand.java
 *   -. Package    : tain.kr.com.test.designpattern.entrance.ch23Interpreter.v03
 *   -. Comment    :
 *   -. Author     : taincokr
 ...
 *
 */
public class NodePrimitiveCommand extends AbstNode {

	private static boolean flag = true;

	private static final Logger log = Logger
			.getLogger(NodePrimitiveCommand.class);
	...
	public void parse(Dep1Context context) throws Exp1ParseException {
		...
		if (!this.name.equalsIgnoreCase("GO")
			...
			throw new Exp1ParseException(this.name + " is undefined..");
		}
	}
