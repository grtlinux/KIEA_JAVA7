...
public class IteratorBookShelf implements ImplIterator {
	...
	/* (non-Javadoc)
	 * @see tain.kr.com.test.designpattern.entrance.ch01Iterator.v04.ImplIterator#hasNext()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see tain.kr.com.test.designpattern.entrance.ch01Iterator.v04.ImplIterator#next()
	 */
	@Override
	public Object next() {
		// TODO Auto-generated method stub
