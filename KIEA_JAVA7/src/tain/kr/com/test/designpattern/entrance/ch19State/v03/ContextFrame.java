...
public class ContextFrame extends Frame implements ImplContext {
	...
	public void setClock(int hour) {
		...
		String strClock = String.format("현재시각은 %02d:00", hour);
	...
	public void changeState(ImplState state) {
		...
		String strMsg = String.format("상태가 %s에서 %s로 상태가 변화했습니다.", this.state, state);
		System.out.println(strMsg);
		
		// System.out.format("상태가 %s에서 %s로 상태가 변화했습니다.\n", this.state, state);
