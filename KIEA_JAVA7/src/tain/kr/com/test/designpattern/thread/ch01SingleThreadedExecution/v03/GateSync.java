 ...
 *
 */
public class GateSync extends AbstGate {

	private static boolean flag = true;

	private static final Logger log = Logger.getLogger(GateSync.class);
	 ...
	 * constructor
	 */
	public GateSync(String gateName) {
